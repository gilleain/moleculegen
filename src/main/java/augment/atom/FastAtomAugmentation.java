 ...
 *
 */
public class FastAtomAugmentation implements IAtomAugmentation {
     ...
     * @param initialAtom
     */
    public FastAtomAugmentation(IAtom initialAtom, ElementConstraints elementConstraints) {
    ...
    public FastAtomAugmentation(IAtomContainer initialContainer, ElementConstraints elementConstraints) {
     ...
     */
    public FastAtomAugmentation(IAtomContainer parent, IAtom atomToAdd, int[] bondOrders, ElementConstraints elementConstraints) {
